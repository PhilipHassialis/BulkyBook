...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public TwilioSettings _twilioOptions { get; private set; }
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            ModelState.AddModelError(string.Empty, "Please check your verification email");
